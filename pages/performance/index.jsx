 ...
 *
 * GitHubActivity chart with full client-side rendering.
 * Page-level SEO is included at the top using the reusable SEO component.
 *
 * Note: set NEXT_PUBLIC_GITHUB_TOKEN in your environment to enable GraphQL access.
 */
...
export default function GitHubActivity() {
  ...
  const computeTooltipPosition = (p) => {
    ...
    const top = py - containerRect.top;
  ...
  return (
    <>
      {/* PAGE SEO */}
      <SEO
        title="Performance & GitHub Activity | Sankha Subhra Das"
        description="GitHub contribution activity, development consistency, and performance-focused engineering metrics for Sankha Subhra Das."
        url="https://www.sankhasubhradasportfolio.in/performance"
        image="/og-image.png"
      />
